...
import 'package:flutter_game_tutorial/entities/asteroids.dart';
import 'package:flutter_game_tutorial/entities/bullets.dart';
  ...
  void update()
   {
    ...
    _listAsteroid.remove((element) => !element.visible);
  }
